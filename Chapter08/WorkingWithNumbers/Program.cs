...
using System.Security.Cryptography; // To use BigInteger.
...
// maxValue si an exclusive upper bound i.e. 7 is not a possible value.
...
// Two new Random methods in .NET 8: GetItems<T>, Shuffle<T>.
