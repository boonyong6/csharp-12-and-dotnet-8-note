...
partial class Program
{
    ...
    #region Filtering included entities
    ...
    #region Filtering and sorting products
    ...
    #region Getting a single entity
    ...
    #region Pattern matching with Like
    ...
    #region Generating a random number in queries
    ...
    #region Lazy loading for no tracking queries
    ...
    private static void LazyLoadingWithNoTracking()
    {
        ...
        foreach (Product p in products)
        {
            WriteLine("{0} is in category named {1}.", 
                p.ProductName, p.Category.CategoryName); // p.Category navigation property is lazy loaded.
        }
    }
